...
This fetches the latest `uplc/evaluation` test cases from the upstream
[`IntersectMBO/plutus`](https://github.com/IntersectMBO/plutus) repository into
`crates/uplc/tests/conformance/`.
