...
impl BuiltinCostsV3 {
    pub fn get_cost(&self, builtin: &str, args: &[i64]) -> Option<ExBudget> {
        match builtin {
            ...
            "verify_ecdsa_secp256k1_signature" => Some(ExBudget::new(
            ...
            "verify_schnorr_secp256k1_signature" => Some(ExBudget::new(
